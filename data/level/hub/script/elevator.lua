...
function init()
	...
	stuckSound = LoadLoop("LEVEL/script/elevator/hydraulic-loop-stuck")
	stopSound = LoadSound("LEVEL/script/elevator/elevator_stop")
	startSound = LoadSound("LEVEL/script/elevator/elevator_start")
	sparkSound = LoadSound("LEVEL/script/elevator/spark-")
