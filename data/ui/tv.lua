	...
	if event > 0 then
		...
		elseif first == "shake" then
			UiPush()
				...
				UiScale(1.05)
				UiPush()
					UiRotate((shakeX+shakeY)*0.005)
					UiImage(second)
				UiPop()
				UiTranslate(-shakeX*5, -shakeY*5)
				UiRotate((shakeX+shakeY)*0.002)
...
function commercial(dt, params)
	if gTime == 0 then
		...
		font1 = params.font1 or "font/bold.ttf"
		font2 = params.font2 or "font/bold.ttf"
		font3 = params.font3 or "font/bold.ttf"
		font4 = params.font4 or "font/bold.ttf"
...
function init()
	...
	--These are shows that only show up after completed for the first time
	...
	if isMissionCompleted("marina_demolish") and not (isMissionCompleted("marina_cars") or isMissionCompleted("marina_gps")) then
		...
		addShow(mystery,
			{
				...
				events = 
				{
					...
					"The four ocean cabins at the Westpoint marina.\nA popular holiday resort since many years.*6|tv/mystery-cabinphoto.jpg", 
	...
	if (isMissionCompleted("mansion_pool") or isMissionCompleted("lee_safe")) and not isMissionCompleted("lee_tower") then
		addShow(news,
			{
		...
		addShow(news,
			{
				...
				ticker = "Lee chemicals famous tower torn down by unknown trespassers. Shameful deed happens right before the 75th anniversary of the tower. Rummaging around in the rubble, Lawrence Lee Jr express grief and anger. \"These half-wit neanderthals don't know what's coming for them! Attacking the heart and soul of my company! Of my family!\" he fumes, visibly upset.",
				public="lawrence-lee-jr",
				events = 
				{
	...
	if isMissionCompleted("marina_art_back") and not isMissionCompleted("mansion_fraud") then
		addShow(newsIntro)
		addShow(news,
			{
	...
	if isMissionCompleted("mansion_fraud") and not isMissionCompleted("caveisland_computers") then
		addShow(newsIntro)
		addShow(news,
			{
	...
	if isMissionCompleted("lee_powerplant") and not isMissionCompleted("caveisland_propane") then
		addShow(newsIntro)
		addShow(news,
			{
	...
	if isMissionCompleted("caveisland_propane") and not isMissionCompleted("caveisland_dishes") then
		addShow(newsIntro)
		addShow(news,
			{
	...
	if isMissionCompleted("frustrum_chase") then
		...
		addShow(news,
			{
				title = "Lee convicted for tax evasion",
				...
				events = 
				{
					"studio tv/lee-convicted1.jpg", 
					"still tv/lee-convicted1.jpg", 
					"still tv/lee-convicted2.jpg", 
					"zoom tv/lee-convicted3.jpg", 
					"studio tv/lee-convicted3.jpg", 
					"studio tv/parisa-mugshot.jpg", 
					"studio",
					"studio",
				}
			}	
		...
		addShow(news,
			{
				title = "New wing at Evertides Mall",
				...
				events = 
				{
					"still tv/evertides4.jpg",
					"studio tv/evertides4.jpg",
					"studio tv/evertides1.jpg",
					"still tv/evertides1.jpg",
					"studio tv/evertides1.jpg",
					"studio tv/evertides3.jpg",
					"studio",
				}
			}	
		)
		...
		addShow(commercial,
			{
				audio = "tv/boon.ogg",
				text1 = "Fine dining",
				image1 = "tv/ad-boon1.jpg",
				text2 = "with an ocean view",
				image2 = "tv/ad-boon2.jpg",
				zoom2 = true,
				text3 = "Visit boon",
				text4 = "by Evertides Mall.",
			}	
		)
	end
